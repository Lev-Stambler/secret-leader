...
% TODO: put in the simple streaming sampler
...
We wil realize MSLE via the following protocol:
\begin{figure}[ht]
	\centering
	\fbox{
		\begin{minipage}{1\textwidth}
...
\begin{lemma}
	...
	\begin{proof}
		...
		\begin{enumerate}
			...
			% \item The simulator samples $b_j$ for all $j \neq i$ where $b_j$ is a commitment to a random value
